...
<div style="display:flex; justify-content:space-between; margin-right:30px; margin-left:30px;">
	...
	<!-- /.box -->
		<div class="box" style="min-height: 32vh; max-height:32vh;">
		...
		<div class="box">
			...
			<!-- /.box-header -->
			<div class="box-body" style="height:311px;"> <!-- 높이 311px 길이맞추느라 추가함 -->
			...
			<div class="box-footer text-end" style="border-top: none; display:flex; justify-content:space-between;">
				<button id="search"  type="submit" class="waves-effect waves-light btn btn-primary mb-5">조회</button>
				<button id="clear" type="submit" class="waves-effect waves-light btn btn-danger mb-5">취소</button>
<!-- 			<button id="clear" type="submit" class="waves-effect waves-light btn mb-5 bg-gradient-danger">비우기</button>
				<button id="search" type="submit" class="waves-effect waves-light btn mb-5 bg-gradient-secondary">조회</button> -->
			</div>
			<!-- /.box-body -->
		</div>
	</div>
	<div class="col-8">
		...
		<div class="box" style="height:28vh;">
			<div class="box-header with-border">
				<h4 class="box-title text-info mb-0"><i class="fa fa-fw fa-won"></i>수납 이력</h4>
  ...
  <div class="modal-dialog" style="width:65%; height:110%;">
	<div class="modal-content">
	  <div class="modal-header" style="display:flex; justify-content:right;">
	  	<h3>
		  	<i style="margin-right:10px" id="print" class="ti-printer"></i>
<!-- 			<button style="background-color:white; margin-right:15px" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
		</h3>
	  </div>
			...
			<div class="hcD" style="left: 20mm; top: 6mm;">
				<div class="hcI">
					<div class="hls ps1"
						...
						<div class="htb"
							...
							<div class="hce" style="left: 30.96mm; top: 25.22mm; width: 28.96mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="recCd" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 27.97mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 86.67mm; top: 25.22mm; width: 27.05mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="mediDepart" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 26.06mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 30.96mm; top: 31.09mm; width: 82.76mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="paName" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 81.77mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 30.96mm; top: 42.83mm; width: 55.71mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="docPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 30.96mm; top: 48.70mm; width: 55.71mm; height: 4.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI">
										<div id="drugPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							...
							<div class="hce" style="left: 30.96mm; top: 53.57mm; width: 55.71mm; height: 6.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 1mm;">
										<div id="treatPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 30.96mm; top: 60.44mm; width: 55.71mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="examPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							<div class="hce"
							...
							<div class="hce" style="left: 30.96mm; top: 95.66mm; width: 55.71mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="diaPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							...
							<div class="hce" style="left: 30.96mm; top: 101.53mm; width: 55.71mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
										<div id="notePay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 54.72mm;"></div>
									</div>
								</div>
							</div>
							...
							<div class="hce" style="left: 30.96mm; top: 107.40mm; width: 55.71mm; height: 5.87mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 0.50mm;">
							...
							<div class="hce" style="left: 30.96mm; top: 113.27mm; width: 82.76mm; height: 10.53mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 2.83mm;">
										<div id="totalPay" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 81.77mm;"></div>
									</div>
								</div>
							</div>
							...
							<div class="hce" style="left: 142.68mm; top: 113.27mm; width: 25.95mm; height: 10.53mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI" style="top: 2.83mm;">
										<div id="recEmpNo" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 24.96mm;">
											<span class="hrt cs0">&nbsp;&nbsp;&nbsp;</span>
										</div>
									</div>
								</div>
					...
					<div class="hls ps5"
						...
						<span class="hrt cs4">DDIT 의료재단 </span></br><span class="hrt cs5">Medical_TechNology</span>
					</div>
					<div class="hls ps5"
					...
					<div class="hls ps0"
						...
						<div class="htb"
							...
							<div class="hce" style="left: 0mm; top: 23.06mm; width: 169.05mm; height: 9.52mm;">
								<div class="hcD" style="left: 0.49mm; top: 0.49mm;">
									<div class="hcI">
										<div id="docNo" class="hls ps1" style="line-height: 3.10mm; white-space: nowrap; left: 0mm; top: -0.19mm; height: 3.88mm; width: 168.06mm;"></div>
									</div>
								</div>
							</div>
						</div>
...
var empName = "";  // 담당의사
var docPay = 5000;  // 진찰료
var treatPay = 0;  // 주사료, 처치료
var drugPay = 0; // 투약, 처방료
var examPay = 0; // 검사료, 영상진단료
var paName = "";  // 환자이름
var notePay = 0;  // 소견서 금액
var diaPay = 0;  // 진단서 금액
var cost = 0;  // 총 금액
var paNo = "";  // 환자 번호
var diaCd = "";  // 진단서코드
...
$(function() {
	...
	$(document).on("click", "#waitList tr", function() {
		...
		var paReg = $(this).children().eq(5).text();
		...
		console.log(paName + "+++++" + paReg + "+++++" + paPh + "+++++" + paFiviDt);
...
//   		}
  		...
  		$.ajax({
			...
			success : function(result) {
				...
				if(result.length == 0) {
					...
					str += "<tr>"; 
					str += "<td colspan='6' rowspan='3' style='text-align:center;'><h1>수납 이력이 없습니다.</h1></td>"; 
					str += "</tr>"; 
	...
	$("#search").on("click", function() {
		...
		if($("input[name=paNo]").val() != "") {
			...
			$.ajax({
				...
				success : function(result) {
					...
					for(var i = 0; i < result.length; i++) {
						...
						str += "<td>" + result[i].olActFee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') + "</td>"
						str += "</tr>"
						
						if(result[i].toVO.toGubun == "검사") {
							examPay += parseInt(result[i].olActFee);
						} else if(result[i].toVO.toGubun == "내복") {
							drugPay += parseInt(result[i].olActFee);
						} else if(result[i].toVO.toGubun == "주사") {
							treatPay += parseInt(result[i].olActFee);
						}
						
						cost += parseInt(result[i].olActFee) + 5000;
			...
			$.ajax({
				...
				success : function(result) {
					console.log("진단서 : " + result[0].diaPmtPrice);
					...
					for(var i = 0; i < result.length; i++) {
						...
						str += "<tr>"
						str += "<td>" + result[i].ctforVO.ctfGubun + "</td>"
						str += "<td>" + result[i].ctforVO.ctfName + "</td>"
						str += "<td>" + dtResultDia + "</td>"
						str += "<td>" + result[i].ctforVO.empName + "</td>"
						str += "<td>" + result[i].diaPmtPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') + "</td>"
						str += "<td style='display:none;'>" + result[i].diaCd + "</td>"
						str += "</tr>"
						
						diaCd = result[i].diaCd
						diaPay += parseInt(result[i].diaPmtPrice);
						cost += parseInt(result[i].diaPmtPrice);
					}
			...
			$.ajax({
				...
				success : function(result) {
					...
					for(var i = 0; i < result.length; i++) {
						...
						str += "<td>" + result[i].ctforVO.empName + "</td>"
						str += "<td>" + result[i].ntPmtPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') + "</td>"
						str += "<td style='display:none;'>" + result[i].ntCd + "</td>"
						str += "</tr>"
								
						ntCd = result[i].ntCd;
						notePay += parseInt(result[i].ntPmtPrice);
						cost += parseInt(result[i].ntPmtPrice);
					}
	...
	$("#payment").on("click", function() {
		...
		var data = {"paNo" : paNo, "recTotal" : recTotal, "recEmpNo" : recEmpNo, "diaCd" : diaCd, "ntCd" : ntCd, "recMt" : recMt};
		...
		$("#totalPay").html(cost.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ','));
		...
		// 담당자 session에서 받아와서 추가 할 예정 or 수납에서 담당자 받아오기
		// 수납에서도 담당자는 session에서 받아와서 넣어줄 예정
		// $("#manager").html(담당자);
		// 담당자 후에 session을 통해서 받아올 예정
