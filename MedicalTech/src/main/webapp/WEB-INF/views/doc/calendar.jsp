		...
		<div id="box">
			<div class="box-header with-border" style="display: flex;padding:0.8rem;padding-bottom:4px;border-bottom:none;">
				<div style="margin-right: 30px;">
					<button type="button" id="nurseCal" class="waves-effect waves-light btn btn-dark btn-flat mb-5">
						<h6 style="color: #3596f7;"><i class="ti-user me-15"></i>간호사 캘린더</h6></button>
				</div>	
				<div>
					<button type="button" id="doctorCal" class="waves-effect waves-light btn btn-dark btn-flat mb-5 active" style="background-color:#15243e;">
			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
				  <div class="modal-header">
					...
					<!-- 환자 검색 버튼 -->
					<sec:authorize access="hasAnyRole('ROLE_DOCTOR,ROLE_ADMINISTRATION,ROLE_MASTER')">
...
<!-- 					<div class="form-group">
				...
				<!--   "<sec:authentication property="principal.empVO.empNo"/>"; -->
				  ...
				  <div class="modal-footer modal-footer-uniform" style="display:flex;justify-content:space-between">
					 <sec:authorize access="hasAnyRole('ROLE_DOCTOR,ROLE_ADMINISTRATION,ROLE_MASTER')">
						<button type="button" id="sav" class="btn btn-info float-end">등록</button>
					...
					<sec:authorize access="!hasAnyRole('ROLE_DOCTOR,ROLE_ADMINISTRATION,ROLE_MASTER')">
				 		<button type="button"  id="notDoc" class="btn btn-danger" data-bs-dismiss="modal" style="position:relative;left:400px;">닫기</button>
				 	</sec:authorize>
				  </div>
				</div>
			  </div>
		...
		<div class="modal center-modal fade" id="paSearchInfo" tabindex="-1" style="display: none;" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content" style="min-height:545px;">
			  <div class="modal-header">
